...
def get_argument_parser():
    ...
    parser.add_argument('--precomp_enc_type', default="basic",
                        help='basic|mlp|selfattention|transformer')
    parser.add_argument('--text_enc_type', default="bigru",
                        help='bigru|bert')
    parser.add_argument('--aggr_type', default="ot",
                        help='gpo|coding|ot')
    ...
    parser.add_argument('--visual_lr_factor', default=0.01, type=float,
                        help='The lr factor for fine-tuning the visual backbone, it will be multiplied to the lr of '
                             'the embedding layers')
    parser.add_argument('--text_lr_factor', default=0.1, type=float,
                        help='The lr factor for fine-tuning the text backbone, it will be multiplied to the lr of '
                             'the embedding layers')
    ...
    parser.add_argument('--visual_mask_ratio', type=float, default=0.2,
                        help='probability of masking features.')
    ...
    parser.add_argument('--KNN', type=int, default=1,
                        help='K nearest neighbors of query.')
